...
func Test_WithContext(t *testing.T) {
	...
	for _, ctx := range []context.Context{
		qCtx.Addr.UnderlyingDB().Statement.Context,
		...
		qCtx.JustUser.UnderlyingDB().Statement.Context,
		qCtx.Passport.UnderlyingDB().Statement.Context,
		qCtx.Person.UnderlyingDB().Statement.Context,
		qCtx.TestField.UnderlyingDB().Statement.Context,
