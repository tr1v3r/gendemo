...
CREATE TABLE `people` (
  ...
  `flag_another` int(11) DEFAULT NULL,
  `bit` blob,
...
INSERT INTO `players` VALUES (1,'tom',18,'nothing else'),(2,'ann',17,'nothing left');
...
-- Dump completed on 2024-01-16 22:53:53
